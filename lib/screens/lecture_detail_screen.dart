    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(widget.lecture.title, style: const TextStyle(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Text("Generated by Local Neural Engine v3.2", style: TextStyle(color: Colors.grey[500], fontSize: 12)),
            const SizedBox(height: 30),
            _buildPlayerCard(),
            const SizedBox(height: 30),
            _buildSummaryCard(),
            const SizedBox(height: 30),
            const Text("TRANSCRIPT", style: TextStyle(color: Colors.grey, fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1.2)),
            const SizedBox(height: 16),
            Container(
              padding: const EdgeInsets.all(20),
              decoration: BoxDecoration(
                color: const Color(0xFF1E293B).withValues(alpha: 0.5), // 修正：withValues
                borderRadius: BorderRadius.circular(20),
              ),
              child: Text(
                widget.lecture.transcript.isEmpty ? "尚無轉錄內容" : widget.lecture.transcript,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(colors: [
          Colors.blueAccent.withValues(alpha: 0.2), // 修正：withValues
        ...
        children: [
          const Row( // 補上 const
            children: [
              ...
              SizedBox(width: 8),
              Text("AI 核心摘要", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            ],
          ),
          const SizedBox(height: 16),
          Text(
            widget.lecture.summary.isEmpty ? "正在分析語音內容以產生摘要..." : widget.lecture.summary,
